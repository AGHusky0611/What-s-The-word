...
public class CreatePlayerUI extends JFrame {
    ...
    private JPanel addAccountRow(String username, String password) {
        ...
        JLabel playerStatus = new JLabel("disconnected" + "   "); // placeholder
        ...
        rowPanel.putClientProperty("username", username); // placeholder
        rowPanel.putClientProperty("password", password); // placecholder

        rowPanel.addMouseListener(new java.awt.event.MouseAdapter() {
            @Override
            public void mouseClicked(java.awt.event.MouseEvent e) {
                String storedUsername = (String) rowPanel.getClientProperty("username"); // placeholders
                String storedPassword = (String) rowPanel.getClientProperty("password");
                ...
                JLabel userText = new JLabel("Username: " + username);
                userText.setBounds(20,15,350,30);
                userText.setFont(new Font("Segoe UI", Font.PLAIN, 22));

                JLabel passtext = new JLabel("Password: " + password);
                passtext.setBounds(20,50,350,30);
                passtext.setFont(new Font("Segoe UI", Font.PLAIN, 22));
