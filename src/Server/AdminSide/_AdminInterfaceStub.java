...
public class _AdminInterfaceStub extends org.omg.CORBA.portable.ObjectImpl implements AdminInterface
{
  ...
  public void banPlayer (String playerId) throws Server.Exceptions.LostConnectionException, Server.Exceptions.NotLoggedInException, Server.Exceptions.NoSuchUserFoundException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("banPlayer", true);
                $out.write_string (playerId);
                $in = _invoke ($out);
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
  ...
  public Server.CommonObjects.User[] getUserList () throws Server.Exceptions.LostConnectionException, Server.Exceptions.NotLoggedInException
  {
            ...
            try {
                ...
                $in = _invoke ($out);
                Server.CommonObjects.User $result[] = usersHelper.read ($in);
                return $result;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
  ...
  public Server.CommonObjects.GameRules changeRules (int newGuessTime, int newRounds, int newGuessLimit) throws Server.Exceptions.LostConnectionException, Server.Exceptions.NotLoggedInException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("changeRules", true);
                $out.write_long (newGuessTime);
                $out.write_long (newRounds);
                $out.write_long (newGuessLimit);
                $in = _invoke ($out);
                ...
                return changeRules (newGuessTime, newRounds, newGuessLimit        );
            } finally {
                _releaseReply ($in);
            }
  } // changeRules
  ...
  public Server.CommonObjects.GameResult[] getGameHistory () throws Server.Exceptions.LostConnectionException, Server.Exceptions.NotLoggedInException
  {
            ...
            try {
                ...
                $in = _invoke ($out);
                Server.CommonObjects.GameResult $result[] = playedSessionsHelper.read ($in);
                return $result;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
