 ...
 implements AdminInterfaceOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("banPlayer", new Integer (3));
    _methods.put ("deleteUser", new Integer (4));
    _methods.put ("getUserList", new Integer (5));
    _methods.put ("searchUser", new Integer (6));
    _methods.put ("changeRules", new Integer (7));
    _methods.put ("getGameHistory", new Integer (8));
    _methods.put ("getPlayerHistory", new Integer (9));
    _methods.put ("ping", new Integer (10));
  }
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       case 3:  // Server/AdminSide/AdminInterface/banPlayer
       {
         try {
           String playerId = in.read_string ();
       ...
       case 4:  // Server/AdminSide/AdminInterface/deleteUser
       {
         try {
           String userId = in.read_string ();
       ...
       case 5:  // Server/AdminSide/AdminInterface/getUserList
       {
         try {
           Server.CommonObjects.User $result[] = null;
       ...
       case 6:  // Server/AdminSide/AdminInterface/searchUser
       {
         try {
           String playerId = in.read_string ();
           Server.CommonObjects.User $result = null;
       ...
       case 7:  // Server/AdminSide/AdminInterface/changeRules
       {
         try {
           int newGuessTime = in.read_long ();
           int newRounds = in.read_long ();
           int newGuessLimit = in.read_long ();
           Server.CommonObjects.GameRules $result = null;
           $result = this.changeRules (newGuessTime, newRounds, newGuessLimit);
           out = $rh.createReply();
       ...
       case 8:  // Server/AdminSide/AdminInterface/getGameHistory
       {
         try {
       ...
       case 9:  // Server/AdminSide/AdminInterface/getPlayerHistory
       {
         try {
           String playerId = in.read_string ();
           Server.CommonObjects.GameResult $result[] = null;
       ...
       case 10:  // Server/AdminSide/AdminInterface/ping
       {
         try {
           String userId = in.read_string ();
           String $result = null;
