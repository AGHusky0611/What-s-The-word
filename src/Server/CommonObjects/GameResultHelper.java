...
abstract public class GameResultHelper
{
  ...
  public static void insert (org.omg.CORBA.Any a, GameResult that)
  {
  ...
  public static GameResult extract (org.omg.CORBA.Any a)
  {
      ...
      synchronized (org.omg.CORBA.TypeCode.class)
      {
        if (__typeCode == null)
        {
          ...
          _members0[5] = new org.omg.CORBA.StructMember (
            ...
            _tcOf_members0,
            null);
          __typeCode = org.omg.CORBA.ORB.init ().create_struct_tc (GameResultHelper.id (), "GameResult", _members0);
          __active = false;
        }
      }
    }
  ...
  public static GameResult read (org.omg.CORBA.portable.InputStream istream)
  {
    GameResult value = new GameResult ();
    value.sessionId = istream.read_string ();
    value.winner = istream.read_string ();
    value.players = StringSequenceHelper.read (istream);
  ...
  public static void write (org.omg.CORBA.portable.OutputStream ostream, GameResult value)
  {
    ostream.write_string (value.sessionId);
    ostream.write_string (value.winner);
    StringSequenceHelper.write (ostream, value.players);
