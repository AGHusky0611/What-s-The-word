...
public class HangmanServer {
    ...
    public static void main(String[] args) {
        try {
            ...
            if (ncRef == null) {
                throw new RuntimeException("Failed to narrow NameService");
            }
            ...
            logger.info("Hangman Server ready and waiting for connections...");
            orb.run();
        } catch (Exception e) {
    ...
    private static void registerPlayerService(POA rootPOA, ORB orb, NamingContextExt ncRef)
            throws ServantNotActive, WrongPolicy, InvalidName,
        ...
        logger.info("Player service registered successfully");
    }
    ...
    private static void registerAdminService(POA rootPOA, ORB orb, NamingContextExt ncRef)
        ...
        logger.info("Admin service registered successfully");
    }
}